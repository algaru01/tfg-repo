# 1 Acercamiento
En este primer acercamiento vamos a crear una instancia de máquina virtual de Google Cloud. Para ello, se ha creado un módulo que se hace uso del recurso 'google_compute_instance' para crear una máquina virtual que requiere necesariamente:
